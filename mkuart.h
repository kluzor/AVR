...
#define _UBRR F_CPU/16/UART_BAUD-1  // obliczamy UBRR dla U2X=0
...
#define UART_RX_BUF_MASK ( UART_RX_BUF_SIZE - 1)// definiujemy maskê dla naszego bufora

#define UART_TX_BUF_SIZE 32 // definiujemy bufor o rozmiarze 64 bajtów
#define UART_TX_BUF_MASK ( UART_TX_BUF_SIZE - 1)// definiujemy maskê dla naszego bufora
